...
Koneksi koneksi = new Koneksi();
    ...
    private void initComponents() {
        ...
        jButtonpindah = new javax.swing.JButton();
        ...
        jLabel2.setText("Nama / No KA :");

        jLabel3.setText("Kelas / Kursi :");
        ...
        jButtonpindah.setText("pindah");
        jButtonpindah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonpindahActionPerformed(evt);
            }
        });

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel7.setText("KERETA API");

        jLabel8.setText("PT. KERETA API INDONESIA (PERSERO)");
    ...
    private void jButtonsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonsimpanActionPerformed
        ...
        String namanoka = jTextField2.getText();
        String kelaskursi = jTextField3.getText();
        String brgkt = jTextField4.getText();
        String tiba = jTextField5.getText();
        int harga = Integer.parseInt(jTextField6.getText());
        
        koneksi.koneksiDatabase();
        try {
           String query = "insert into tbl_keretaapi(nama,nama_noka,kelas_kursi,berangkat,tiba,harga) values('"+nama+"','"+namanoka+"','"+kelaskursi+"','"+brgkt+"','"+tiba+"','"+harga+"')";
    ...
    private void jButtonpindahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonpindahActionPerformed
        // TODO add your handling code here:
        Tampil pindah = new Tampil();
        pindah.setVisible(true);
        
    }//GEN-LAST:event_jButtonpindahActionPerformed
    ...
    private javax.swing.JButton jButtonpindah;
